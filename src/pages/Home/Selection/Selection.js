        ...
        <section className="selection">
            <div className="container">
                <div className="selection__nav">
                    ...
                    <Link to={'/'} className="selection__link">
                        Смотреть все
                    </Link>
                </div>
